...
public class Parser_JUnitTest {
    ...
    public void testMain_readString() {
        ...
        Assertions.assertEquals(jsonObjectsList, Main.readString(inputTestFileName));
    }
    ...
    public void testMain_jsonsToList() {
        ...
        Assertions.assertEquals(employeeList, Main.jsonsToList(jsonObjects));
    }
}
